...
class NoteAPITest {
    ...
    fun setup() {
        ...
        codeApp = Note("Code App", 4, "Work", "Doing", true)
        testApp = Note("Test App", 4, "Work", "Doing", false)
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that does not exist returns false`() {
            ...
            assertFalse(populatedNotes!!.updateNote(-1, Note("Updating Note", 2, "Work", "Done", false)))
